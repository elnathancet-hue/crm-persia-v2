...
// DialogHero — header padrao pra Dialogs de formulario.
// Espelha o pattern do studio (referencia visual aprovada): box de
// icone colorido a esquerda + titulo grande + tagline em uppercase
// letterspaced. Adicionado em PR-K6.5 (originalmente em crm-ui),
// movido pra @persia/ui em PR-K8 pra ficar disponivel em qualquer
// pacote (agenda-ui consome sem criar dep cruzada).
//
...
// internos — caller faz isso (DialogTitle vai como sr-only pra
// preservar a11y do Radix).
