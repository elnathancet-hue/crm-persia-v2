...
// PR-S2 (movido de apps/crm/src/lib/realtime): hook combinado de
// presence + comments num lead. 1 canal `lead-${leadId}` so.
//
// DI: recebe supabase como param. Cleanup ordem: untrack -> removeChannel
// pra evitar ghost de 30s.
