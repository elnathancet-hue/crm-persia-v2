...
const nextConfig: NextConfig = {
  ...
  // Next.js 15.5.x reconhece serverActions APENAS dentro de experimental.
  // Colocar no root causa "Unrecognized key" e o limite volta pra 1MB.
  // 20MB: bucket 'tools' (20971520 bytes), WhatsApp video/audio (16MB) + folga.
  experimental: {
    serverActions: {
      bodySizeLimit: "20mb",
    },
